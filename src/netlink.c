...
{
	struct net *tmp_net;
	tmp_net = get_net_ns_by_id(&init_net, netns_id);		
	return tmp_net;
}
...
{
	uint32_t netns_id;
	netns_id = peernet2id(&init_net, net);		
	return netns_id;
}
#else
...
#define K_SECURE_INTERFACE_NAME_BY_NAME						"Request the securing of a network interface"
#define K_UNSECURE_INTERFACE_NAME						"Request the unsecuring of a network interface"
#define K_UNSECURE_INTERFACE_NAME_BY_NAME					"Request the unsecuring of a network interface"
...
enum {
	...
	K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME,
...
typedef struct k_load_node_certificate_and_secure_interface_msg {
	...
	uint32_t	node_dh_privatekey_filename_len;
	unsigned char*	node_dh_privatekey_filename;
...
static struct nla_policy k_load_node_certificate_and_secure_interface_genl_policy[K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_MAX + 1] = {
	[K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_NODE_CERT_FILENAME]				=	{ .type = NLA_UNSPEC	},
	[K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME]			=	{ .type = NLA_UNSPEC	},
	[K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_INTERFACE_NAME]				=	{ .type = NLA_UNSPEC	},
};

// K_SECURE_INTERFACE
enum {
	__K_SECURE_INTERFACE_ATTR_FIRST = 0,
	K_SECURE_INTERFACE_ATTR_NETNS_ID,
...
static struct nla_policy k_secure_interface_genl_policy[K_SECURE_INTERFACE_ATTR_MAX + 1] = {
	[K_SECURE_INTERFACE_ATTR_NETNS_ID]								=	{ .type = NLA_U32	},
...
static struct nla_policy k_secure_interface_by_name_genl_policy[K_SECURE_INTERFACE_BY_NAME_ATTR_MAX + 1] = {
	[K_SECURE_INTERFACE_BY_NAME_ATTR_INTERFACE_NAME]						=	{ .type = NLA_UNSPEC	},
};

// K_UNSECURE_INTERFACE
enum {
	__K_UNSECURE_INTERFACE_ATTR_FIRST = 0,
	K_UNSECURE_INTERFACE_ATTR_NETNS_ID,
...
static struct nla_policy k_unsecure_interface_genl_policy[K_UNSECURE_INTERFACE_ATTR_MAX + 1] = {
	[K_UNSECURE_INTERFACE_ATTR_NETNS_ID]								=	{ .type = NLA_U32	},
...
static struct nla_policy k_unsecure_interface_by_name_genl_policy[K_UNSECURE_INTERFACE_BY_NAME_ATTR_MAX + 1] = {
	[K_UNSECURE_INTERFACE_BY_NAME_ATTR_INTERFACE_NAME]						=	{ .type = NLA_UNSPEC	},
};
...
enum {
	...
	K_UPDATE_SUPERMAN_SECURITY_TABLE_ENTRY_ATTR_NETNS_ID,
...
static struct nla_policy k_update_superman_security_table_entry_genl_policy[K_UPDATE_SUPERMAN_SECURITY_TABLE_ENTRY_ATTR_MAX + 1] = {
	[K_UPDATE_SUPERMAN_SECURITY_TABLE_ENTRY_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	K_UPDATE_SUPERMAN_BROADCAST_KEY_ATTR_NETNS_ID,
...
static struct nla_policy k_update_superman_broadcast_key_genl_policy[K_UPDATE_SUPERMAN_BROADCAST_KEY_ATTR_MAX + 1] = {
	[K_UPDATE_SUPERMAN_BROADCAST_KEY_ATTR_NETNS_ID]						=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_discovery_request_genl_policy[K_SEND_SUPERMAN_DISCOVERY_REQUEST_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_certificate_request_genl_policy[K_SEND_SUPERMAN_CERTIFICATE_REQUEST_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_certificate_exchange_genl_policy[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_certificate_exchange_with_broadcast_key_genl_policy[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID]			=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_broadcast_key_exchange_genl_policy[K_SEND_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	K_SEND_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID,
...
static struct nla_policy k_send_superman_sk_invalidate_genl_policy[K_SEND_SUPERMAN_SK_INVALIDATE_ATTR_MAX + 1] = {
	[K_SEND_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID]						=	{ .type = NLA_U32	},
...
enum {
	...
	D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_NETNS_ID,
	...
	D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME,
...
static struct nla_policy d_load_node_certificate_then_secure_interface_genl_policy[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_MAX + 1] = {
	[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_NETNS_ID]				=	{ .type = NLA_U32	},
	[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_IFINDEX]				=	{ .type = NLA_U32	},
	[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_NODE_CERT_FILENAME]			=	{ .type = NLA_UNSPEC	},
	[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME]		=	{ .type = NLA_UNSPEC	}
};

// D_RAISE_SUPERMAN_DISCOVERY_REQUEST
enum {
	__D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_FIRST = 0,
	D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,
...
static struct nla_policy d_raise_superman_discovery_request_genl_policy[D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_MAX + 1] = {
	[D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	D_RAISE_NEW_BROADCAST_KEY_ATTR_NETNS_ID,
...
static struct nla_policy d_raise_new_broadcast_key_genl_policy[D_RAISE_NEW_BROADCAST_KEY_ATTR_MAX + 1] = {
	[D_RAISE_NEW_BROADCAST_KEY_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_discovery_request_genl_policy[D_RECEIVED_SUPERMAN_DISCOVERY_REQUEST_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_certificate_request_genl_policy[D_RECEIVED_SUPERMAN_CERTIFICATE_REQUEST_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_certificate_exchange_genl_policy[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID]				=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_certificate_exchange_with_broadcast_key_genl_policy[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID]		=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_AUTHENTICATED_SK_RESPONSE_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_authenticated_sk_response_genl_policy[D_RECEIVED_SUPERMAN_AUTHENTICATED_SK_RESPONSE_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_AUTHENTICATED_SK_RESPONSE_ATTR_NETNS_ID]				=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_sk_invalidate_genl_policy[D_RECEIVED_SUPERMAN_SK_INVALIDATE_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID]					=	{ .type = NLA_U32	},
...
enum {
	...
	D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID,
...
static struct nla_policy d_received_superman_broadcast_key_exchange_genl_policy[D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_MAX + 1] = {
	[D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID]				=	{ .type = NLA_U32	},
	[D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_IFINDEX]				=	{ .type = NLA_U32	},
	[D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_BROADCAST_KEY]				=	{ .type = NLA_UNSPEC	},
};
...
int k_load_node_certificate_and_secure_interface(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	GENL_MALLOC(node_dh_privatekey_filename, node_dh_privatekey_filename_len, K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_INTERFACE_NAME);
	GENL_MALLOC(interface_name, interface_name_len, K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_INTERFACE_NAME);

	LoadNodeCertificateAndSecureInterface(node_cert_filename_len, node_cert_filename, node_dh_privatekey_filename_len, node_dh_privatekey_filename, interface_name_len, interface_name);

	GENL_FREE(node_cert_filename);
	GENL_FREE(node_dh_privatekey_filename);
...
int k_secure_interface(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SECURE_INTERFACE_ATTR_NETNS_ID]);
...
int k_unsecure_interface(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_UNSECURE_INTERFACE_ATTR_NETNS_ID]);
	ifindex = nla_get_u32(attrs[K_UNSECURE_INTERFACE_ATTR_IFINDEX]);

	UnsecureInterface(netns_id, ifindex);
...
int k_update_superman_security_table_entry(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_UPDATE_SUPERMAN_SECURITY_TABLE_ENTRY_ATTR_NETNS_ID]);
	...
	UpdateSupermanSecurityTableEntry(netns_id, ifindex, address, flag, sk_len, sk, ske_len, ske, skp_len, skp, timestamp);
...
int k_update_superman_broadcast_key(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_UPDATE_SUPERMAN_BROADCAST_KEY_ATTR_NETNS_ID]);
	...
	UpdateSupermanBroadcastKey(netns_id, ifindex, sk_len, sk, ske_len, ske, skp_len, skp, overwrite);
...
int k_send_superman_discovery_request(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]);
...
int k_send_superman_certificate_request(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID]);
	...
	SendSupermanCertificateRequest(netns_id, ifindex, address, sk_len, sk);
...
int k_send_superman_certificate_exchange(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID]);
	...
	SendSupermanCertificateExchange(netns_id, ifindex, address, certificate_len, certificate);
...
int k_send_superman_certificate_exchange_with_broadcast_key(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID]);
	...
	SendSupermanCertificateExchangeWithBroadcastKey(netns_id, ifindex, address, certificate_len, certificate);
...
int k_send_superman_broadcast_key_exchange(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID]);
	...
	SendSupermanBroadcastKeyExchange(netns_id, ifindex, broadcast_key_len, broadcast_key, only_if_changed);
...
int k_send_superman_sk_invalidate(struct sk_buff *skb_msg, struct genl_info *info)
{
	...
	netns_id = nla_get_u32(attrs[K_SEND_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID]);
	...
	SendSupermanSKInvalidate(netns_id, ifindex, address);
...
int d_load_node_certificate_then_secure_interface(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_NETNS_ID]);
	...
	GENL_MALLOC(node_dh_privatekey_filename, node_dh_privatekey_filename_len, D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME);

	LoadNodeCertificateThenSecureInterface(netns_id, ifindex, node_cert_filename_len, node_cert_filename, node_dh_privatekey_filename_len, node_dh_privatekey_filename);
...
int d_raise_superman_discovery_request(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]);
	ifindex = nla_get_u32(attrs[D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_IFINDEX]);

	RaiseSupermanDiscoveryRequest(netns_id, ifindex);
...
int d_raise_new_broadcast_key(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RAISE_NEW_BROADCAST_KEY_ATTR_NETNS_ID]);
	ifindex = nla_get_u32(attrs[D_RAISE_NEW_BROADCAST_KEY_ATTR_IFINDEX]);

	RaiseNewBroadcastKey(netns_id, ifindex);
...
int d_received_superman_discovery_request(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID]);
	...
	ReceivedSupermanDiscoveryRequest(netns_id, ifindex, address, sk_len, sk, timestamp);
...
int d_received_superman_certificate_request(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID]);
	...
	ReceivedSupermanCertificateRequest(netns_id, ifindex, address, sk_len, sk, timestamp);
...
int d_received_superman_certificate_exchange(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID]);
	...
	ReceivedSupermanCertificateExchange(netns_id, ifindex, address, sk_len, sk, certificate_len, certificate);
...
int d_received_superman_certificate_exchange_with_broadcast_key(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID]);
	...
	ReceivedSupermanCertificateExchangeWithBroadcastKey(netns_id, ifindex, address, sk_len, sk, certificate_len, certificate, broadcast_key_len, broadcast_key);
...
int d_received_superman_authenticated_sk_response(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_AUTHENTICATED_SK_RESPONSE_ATTR_NETNS_ID]);
	...
	ReceivedSupermanAuthenticatedSKResponse(netns_id, ifindex, address, sk_len, sk, timestamp);
...
int d_received_superman_sk_invalidate(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID]);
	...
	ReceivedSupermanSKInvalidate(netns_id, ifindex, address);
...
int d_received_superman_broadcast_key_exchange(struct nlmsghdr *nlh)
{
	...
	netns_id = nla_get_u32(attrs[D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID]);
	...
	ReceivedSupermanBroadcastKeyExchange(netns_id, ifindex, broadcast_key_len, broadcast_key);
...
int d_superman_messaging_callback(struct nl_msg* msg, void* arg)
{
	...
	switch(genlh->cmd)
	{
		case D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE:
			return d_load_node_certificate_then_secure_interface(nlh);
			break;
		case D_RAISE_SUPERMAN_DISCOVERY_REQUEST:
			return d_raise_superman_discovery_request(nlh);
			break;
		case D_RAISE_NEW_BROADCAST_KEY:
			return d_raise_new_broadcast_key(nlh);
			break;
...
void LoadNodeCertificateAndSecureInterface(uint32_t node_cert_filename_len, unsigned char* node_cert_filename, uint32_t node_dh_privatekey_filename_len, unsigned char* node_dh_privatekey_filename, uint32_t interface_name_len, unsigned char* interface_name)
{
	...
	if(
		...
		nla_put		(msg,	K_LOAD_NODE_CERTIFICATE_AND_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME,	node_dh_privatekey_filename_len,	node_dh_privatekey_filename	) ||
...
void SecureInterface(uint32_t netns_id, uint32_t ifindex)
{
	...
	if(
		nla_put_u32	(msg,	K_SECURE_INTERFACE_ATTR_NETNS_ID,											netns_id		) ||
...
void UnsecureInterface(uint32_t netns_id, uint32_t ifindex)
{
	...
	if(
		nla_put_u32	(msg,	K_UNSECURE_INTERFACE_ATTR_NETNS_ID,											netns_id		) ||
...
void UpdateSupermanSecurityTableEntry(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint8_t flag, uint32_t sk_len, unsigned char* sk, uint32_t ske_len, unsigned char* ske, uint32_t skp_len, unsigned char* skp, int32_t timestamp)
{
	...
	if(
		nla_put_u32	(msg,	K_UPDATE_SUPERMAN_SECURITY_TABLE_ENTRY_ATTR_NETNS_ID,							netns_id	) ||
...
void UpdateSupermanBroadcastKey(uint32_t netns_id, uint32_t ifindex, uint32_t sk_len, unsigned char* sk, uint32_t ske_len, unsigned char* ske, uint32_t skp_len, unsigned char* skp, bool overwrite)
{
	...
	if(
		nla_put_u32	(msg,	K_UPDATE_SUPERMAN_BROADCAST_KEY_ATTR_NETNS_ID,								netns_id	) ||
...
void SendSupermanDiscoveryRequest(uint32_t netns_id, uint32_t ifindex, uint32_t sk_len, unsigned char* sk)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,							netns_id	) ||
...
void SendSupermanCertificateRequest(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t sk_len, unsigned char* sk)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID,							netns_id	) ||
...
void SendSupermanCertificateExchange(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t certificate_len, unsigned char* certificate)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID,							netns_id	) ||
...
void SendSupermanCertificateExchangeWithBroadcastKey(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t certificate_len, unsigned char* certificate)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID,					netns_id	) ||
...
void SendSupermanBroadcastKeyExchange(uint32_t netns_id, uint32_t ifindex, uint32_t broadcast_key_len, unsigned char* broadcast_key, bool only_if_changed)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID,							netns_id	) ||
...
void SendSupermanSKInvalidate(uint32_t netns_id, uint32_t ifindex, uint32_t address)
{
	...
	if(
		nla_put_u32	(msg,	K_SEND_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID,								netns_id	) ||
...
void LoadNodeCertificateThenSecureInterface(uint32_t netns_id, uint32_t ifindex, uint32_t node_cert_filename_len, unsigned char* node_cert_filename, uint32_t node_dh_privatekey_filename_len, unsigned char* node_dh_privatekey_filename)
{
	...
	if(
		nla_put_u32	(skb,	D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_NETNS_ID,								netns_id			) ||
		...
		nla_put		(skb,	D_LOAD_NODE_CERTIFICATE_THEN_SECURE_INTERFACE_ATTR_DH_PRIVATEKEY_FILENAME,	node_dh_privatekey_filename_len,	node_dh_privatekey_filename	))
		fail = 1;
	K_GENL_FINISH
}
...
void RaiseSupermanDiscoveryRequest(uint32_t netns_id, uint32_t ifindex)
{
	...
	if(
		nla_put_u32	(skb,	D_RAISE_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,							netns_id	) ||
...
void RaiseNewBroadcastKey(uint32_t netns_id, uint32_t ifindex)
{
	...
	if(
		nla_put_u32	(skb,	D_RAISE_NEW_BROADCAST_KEY_ATTR_NETNS_ID,								netns_id	) ||
...
void ReceivedSupermanDiscoveryRequest(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t sk_len, unsigned char* sk, int32_t timestamp)
{
	...
	if(
		nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_DISCOVERY_REQUEST_ATTR_NETNS_ID,							netns_id	) ||
...
void ReceivedSupermanCertificateRequest(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t sk_len, unsigned char* sk, int32_t timestamp)
{
	...
	if(
		nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_CERTIFICATE_REQUEST_ATTR_NETNS_ID,							netns_id	) ||
...
void ReceivedSupermanCertificateExchange(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t certificate_len, unsigned char* certificate)
{
	...
	if(GetSecurityTableEntry(GetNetFromNSID(netns_id), ifindex, address, &e))
	{
		K_GENL_START(D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE)
		if(
			nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_ATTR_NETNS_ID,						netns_id	) ||
...
void ReceivedSupermanCertificateExchangeWithBroadcastKey(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t certificate_len, unsigned char* certificate, uint32_t broadcast_key_len, unsigned char* broadcast_key)
{
	...
	if(GetSecurityTableEntry(GetNetFromNSID(netns_id), ifindex, address, &e))
	{
		...
		if(
			nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_CERTIFICATE_EXCHANGE_WITH_BROADCAST_KEY_ATTR_NETNS_ID,				netns_id	) ||
...
void ReceivedSupermanAuthenticatedSKResponse(uint32_t netns_id, uint32_t ifindex, uint32_t address, uint32_t sk_len, unsigned char* sk, int32_t timestamp)
{
	...
	if(
		nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_AUTHENTICATED_SK_RESPONSE_ATTR_NETNS_ID,						netns_id	) ||
...
void ReceivedSupermanSKInvalidate(uint32_t netns_id, uint32_t ifindex, uint32_t address)
{
	...
	if(
		nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_SK_INVALIDATE_ATTR_NETNS_ID,							netns_id	) ||
...
void ReceivedSupermanBroadcastKeyExchange(uint32_t netns_id, uint32_t ifindex, uint32_t broadcast_key_len, unsigned char* broadcast_key)
{
	...
	if(
		nla_put_u32	(skb,	D_RECEIVED_SUPERMAN_BROADCAST_KEY_EXCHANGE_ATTR_NETNS_ID,						netns_id	) ||
